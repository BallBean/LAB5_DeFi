...
contract RPSLS is CommitReveal, TimeUnit {
    ...
    function Revealchoice(bytes32 Encodeddata) public Onlyallowed {
        ...
        require(getHash(Encodeddata) == Playercommit[msg.sender], "Invalid reveal");
    ...
    function Withdrawduringcommitphase() public Onlyallowed {
        require(Gameactive, "No active game");
        require(block.timestamp >= Commitstarttime + 5, "Must wait 5 seconds to withdraw");
        require(Numinput == 0, "Cannot withdraw after reveal starts");
    ...
    function Withdrawduringrevealphase() public Onlyallowed {
        require(Gameactive, "No active game");
        require(Playerrevealed[Players[0]] || Playerrevealed[Players[1]], "At least one player must reveal");
        ...
        if (!Playerrevealed[Players[0]]) {
            ...
            revert("Both players have already revealed");
        }
